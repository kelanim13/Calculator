class Calculator {
    ...
    updateDisplay(){
        this.currentOperandandTextElement.innerText = this.getNumberDispaly(this.currentOperand)
        if(this.operation != null){
            this.previousOperandandTextElement.innerText = 
            this.getNumberDispaly(this.previousOperand) + this.operation
        } else {
            this.previousOperandandTextElement.innerText = ''
        }
    }
